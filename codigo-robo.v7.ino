...
A0 = sensor proximidade bloco - retirar
*/
...
void ler_infras_linhas() {
  ...
  leituraObstaculo = digitalRead(A0);
  if (leituraObstaculo == LOW) {
    estado = PARADA;
  } else {
    estado = SEGUIR_LINHA;
  }
  //debug(leituraObstaculo, "valor leitura obstaculo");
